"""
High-performance C extensions for quantum lattice simulator - FIXED VERSION
Critical functions rewritten in C for maximum performance with proper Windows/MSVC compatibility.
"""
